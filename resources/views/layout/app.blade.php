...
<head>
    ...
    <link href="{{ asset('metronic/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('metronic/dist/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
        type="text/css" />
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{ asset('metronic/dist/assets/media/avatars/300-20.jpg') }}"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('metronic/dist/assets/media/avatars/300-1.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('metronic/dist/assets/media/avatars/300-23.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="" class="w-30px me-3"
                                                src="{{ asset('metronic/dist/assets/media/svg/files/pdf.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="../../demo38/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="{{ asset('metronic/dist/assets/media/svg/files/doc.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            ...
                                            <img alt="../../demo38/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="{{ asset('metronic/dist/assets/media/svg/files/css.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('metronic/dist/assets/media/stock/600x400/img-29.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('metronic/dist/assets/media/stock/600x400/img-31.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('metronic/dist/assets/media/stock/600x400/img-40.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('metronic/dist/assets/media/avatars/300-4.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="pt-5 tab-pane fade show active"
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo38/dist/dashboards/pos.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    ...
                                                    Courses</a>
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo38/dist/dashboards/school.html">Hello Tyler</a>
                                                <a class="fw-6 fw-semibold"
                                ...
                                <div class="mb-10 mb-lg-17">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo38/dist/pages/faq/classic.html">FAQ Classic</a>
                                            </div>
                                            <!--end::List-->
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo38/dist/pages/faq/extended.html">FAQ Extended</a>
                                            </div>
                                            <!--end::List-->
                                        </div>
                                        <!--end::Col-->
